...
CSV_CONFIG = {
    ...
    "brand": {
        "file": "brand-design.csv",
        "search_cols": [
            "Brand", "Category", "Theme_Description", "Keywords",
            "Heading_Font", "Body_Font", "Typography_Mood",
            "Shadow_Style", "Border_Radius_Style",
            "Dos", "Donts", "Key_Characteristics"
        ],
        "output_cols": [
            "Brand", "Category", "Theme_Description", "Keywords",
            ...
            "Shadow_Style", "Border_Radius_Style", "Spacing_Base",
            "Dos", "Donts", "Key_Characteristics", "Design_MD_Path"
        ]
    }
}
...
def detect_domain(query):
    ...
    domain_keywords = {
        ...
        "brand": [
            "brand", "design system", "design.md", "inspired by", "look like",
            "reference brand", "brand style", "brand identity", "brand design",
            "like stripe", "like airbnb", "like spotify", "like notion", "like apple",
            "stripe", "airbnb", "spotify", "apple", "tesla", "uber", "notion",
            "figma", "vercel", "linear", "supabase", "coinbase", "revolut",
            "ferrari", "bmw", "lamborghini", "cursor", "raycast", "framer",
            "pinterest", "nvidia", "spacex", "mongodb", "hashicorp", "miro",
            "sentry", "posthog", "intercom", "kraken", "webflow", "zapier",
            "ollama", "cohere", "replicate", "warp", "resend", "mintlify",
            "superhuman", "clickhouse", "wise", "renault", "lovable", "expo",
            "elevenlabs", "composio", "sanity", "clay", "airtable", "cal.com",
            "minimax", "runway", "voltagent"
        ]
    }
